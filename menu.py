...
class Menu:
    def __init__(self):
        ...
        self.font = pygame.font.Font(UI_OUTLINE, 48)
        self.font_txt = pygame.font.Font(UI_FONT, 46)
        ...
        self.start_text = self.font_txt.render("Start Game", True, MENU_BUTTON_COLOR)
        self.quit_text = self.font_txt.render("Quit", True, MENU_BUTTON_COLOR)
